...
## Demo
🎯 **Live Project:** [Click here to try it online](https://autonomous-learning-agent.onrender.com)  
...
autonomous_agent_project/
│
├── app.py # Flask application
├── agent.py # AI agent logic
├── environment.py # Grid environment and obstacle logic
